...
class PaymentCardDetails extends StatefulWidget {
  ...
  @override
  PaymentCardDetailsState createState() => new PaymentCardDetailsState();
}

class PaymentCardDetailsState extends State<PaymentCardDetails> {
  String cardNo = "**** **** **** ****";
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          foregroundColor: Colors.green[900], elevation: 0),
                      child: Text(
                        "CONTINUE",
