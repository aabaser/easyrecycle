...
class ToolbarBottomScroll extends StatefulWidget {
  ToolbarBottomScroll();

  @override
  ToolbarBottomScrollState createState() => new ToolbarBottomScrollState();
}

class ToolbarBottomScrollState extends State<ToolbarBottomScroll>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: NotificationListener<ScrollNotification>(
        ...
        child: ListNewsCardAdapter(items, onItemClick)
            .getWidgetView(padding: EdgeInsets.symmetric(vertical: 15)),
      ),
