...
class AppIntroCards extends StatefulWidget {
  AppIntroCards();

  @override
  AppIntroCardsState createState() => new AppIntroCardsState();
}

class AppIntroCardsState extends State<AppIntroCards> {
              ...
              Container(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.pink[600], elevation: 0),
  ...
  Widget buildDots(BuildContext context) {
    ...
    for (int i = 0; i < wizardData.length; i++) {
      Widget w = Container(
        ...
        width: 8,
        child: CircleAvatar(
          backgroundColor: page == i ? Colors.pink[600] : MyColors.grey_40,
        ),
      );
      dots.add(w);
    }
