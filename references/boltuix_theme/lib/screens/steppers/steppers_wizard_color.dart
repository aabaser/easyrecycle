...
class SteppersWizardColor extends StatefulWidget {
  SteppersWizardColor();

  @override
  SteppersWizardColorState createState() => new SteppersWizardColorState();
}

class SteppersWizardColorState extends State<SteppersWizardColor> {
