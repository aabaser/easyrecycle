...
import 'package:boltuix/adapter/list_news_light_adapter.dart';
...
class ListNewsLight extends StatefulWidget {
  ListNewsLight();

  @override
  ListNewsLightState createState() => new ListNewsLightState();
}

class ListNewsLightState extends State<ListNewsLight> {
