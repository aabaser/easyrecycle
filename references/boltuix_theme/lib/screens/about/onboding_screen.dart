...
class AboutOnboarding extends StatefulWidget {
  const AboutOnboarding({super.key});

  @override
  State<AboutOnboarding> createState() => _AboutOnboardingState();
}

class _AboutOnboardingState extends State<AboutOnboarding> {
