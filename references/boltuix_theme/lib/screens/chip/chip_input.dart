...
import 'package:boltuix/adapter/list_photo_info_adapter.dart';
...
class ChipInput extends StatefulWidget {
  ...
  @override
  ChipInputState createState() => new ChipInputState();
}
    ...
    for (int i = 0; i < selectedItems.length; i++) {
      ...
      selectedWidget.add(Chip(
        avatar: Container(
          ...
          child:
              Icon(p.icon, size: 22, color: Colors.green), // Changed to green
        ),
        label: Container(
          padding: EdgeInsets.only(top: 6),
          height: 28,
          child: Text(p.title!, style: TextStyle(color: MyColors.grey_80)),
        ),
