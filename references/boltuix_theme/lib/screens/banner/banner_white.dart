...
class BannerWhite extends StatefulWidget {
  BannerWhite();

  @override
  BannerWhiteState createState() => new BannerWhiteState();
}

class BannerWhiteState extends State<BannerWhite>
                ...
                Card(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Unable to perform the search while offline.",
