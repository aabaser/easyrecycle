...
class BannerPin extends StatefulWidget {
  BannerPin();

  @override
  BannerPinState createState() => new BannerPinState();
}

class BannerPinState extends State<BannerPin> with TickerProviderStateMixin {
  bool expand = false;
    ...
    return new Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(child: GridAlbumAdapter(items, onItemClick).getView())
        ],
      ),
    );
  }
